...
* **app:** macOS/visionOS APNs push registration ([#751](https://github.com/DaveDev42/teleprompter/issues/751)) ([3d709c2](https://github.com/DaveDev42/teleprompter/commit/3d709c2952e4d8d4d38ec4c3323caa5e4bd4032d))
* **app:** stop/delete sessions over relay — new session.delete control path + Stop button ([#735](https://github.com/DaveDev42/teleprompter/issues/735)) ([858e0e1](https://github.com/DaveDev42/teleprompter/commit/858e0e17d360c96b94b488711d21979ee2a45310))
* **app:** wire app-side APNs token registration + relay.push.register send + relay.notification inbound ([#742](https://github.com/DaveDev42/teleprompter/issues/742)) ([a9f3f7a](https://github.com/DaveDev42/teleprompter/commit/a9f3f7af785188a699a55641f170be9b931cb1b2))
* **app:** worktree management UI (list/create/remove) wired to daemon worktree IPC ([#750](https://github.com/DaveDev42/teleprompter/issues/750)) ([bad0c8e](https://github.com/DaveDev42/teleprompter/commit/bad0c8e2ce47a6fb1a05c2131dc4cce2c6600d85))
* **ci:** ASC-API TestFlight secret automation script (5-platform cert+profile issuance) ([#795](https://github.com/DaveDev42/teleprompter/issues/795)) ([87c7ca2](https://github.com/DaveDev42/teleprompter/commit/87c7ca2d08927ec0ab3f0a1fd2f2864158158a21))
* **ci:** auto-dispatch TestFlight after release (continuous deployment) ([#798](https://github.com/DaveDev42/teleprompter/issues/798)) ([75f8307](https://github.com/DaveDev42/teleprompter/commit/75f8307f423f812c2972ea9d082fbdea27fdf2bd))
* **ci:** companion-embed watchOS into iOS app (bundle ids 3→2) ([#799](https://github.com/DaveDev42/teleprompter/issues/799)) ([87fc720](https://github.com/DaveDev42/teleprompter/commit/87fc72024f68df936eb59c3c6c2a45fc46347954))
* **ci:** macOS Mac App Store TestFlight archive + upload job ([#792](https://github.com/DaveDev42/teleprompter/issues/792)) ([b0bc3d0](https://github.com/DaveDev42/teleprompter/commit/b0bc3d0f16c294d60e92e67eac695eeccba550dc))
* **ci:** TestFlight deployment pipeline (GitHub Actions, replaces removed EAS Submit) ([#774](https://github.com/DaveDev42/teleprompter/issues/774)) ([c43eb53](https://github.com/DaveDev42/teleprompter/commit/c43eb5323cbd62980267bb32c9946988142ec32a))
* **ci:** visionOS App Store TestFlight archive + upload job ([#793](https://github.com/DaveDev42/teleprompter/issues/793)) ([8929e1c](https://github.com/DaveDev42/teleprompter/commit/8929e1cc02ef7c50191aefd3ea02c8bfb17300cd))
* **ci:** watchOS standalone TestFlight archive + upload (5-platform complete) ([#794](https://github.com/DaveDev42/teleprompter/issues/794)) ([b6a0128](https://github.com/DaveDev42/teleprompter/commit/b6a0128eae127eb0ebf9aec0aeeb7062ce1b6881))
* **relay:** wire relay.push dispatch → APNs async delivery in the Rust relay ([#743](https://github.com/DaveDev42/teleprompter/issues/743)) ([c145bec](https://github.com/DaveDev42/teleprompter/commit/c145bec5c20a4a5189bd3a0f4c2fa50f46bace50))
* **relay:** wire relay.push.register token routing in the Rust relay ([#741](https://github.com/DaveDev42/teleprompter/issues/741)) ([ddb9d41](https://github.com/DaveDev42/teleprompter/commit/ddb9d41efa0e77ffbbf08b97840940ef245d3602))


### Bug Fixes

* **app:** reject non-WebSocket relay URL schemes (transport-downgrade guard) ([#761](https://github.com/DaveDev42/teleprompter/issues/761)) ([95ff4a8](https://github.com/DaveDev42/teleprompter/commit/95ff4a8d843c3c56189d2aa9538ea1fc9c58097e))
* **app:** repair watchOS build — sync TeleprompterWatch source list + guard iOS-only push refs ([#780](https://github.com/DaveDev42/teleprompter/issues/780)) ([3a7670d](https://github.com/DaveDev42/teleprompter/commit/3a7670d6881190c7855f0a2dffd36b80aa2b36c6))
* **ci:** ASC setup script crashed on first API call + GIT_DIR test isolation ([#796](https://github.com/DaveDev42/teleprompter/issues/796)) ([40e5365](https://github.com/DaveDev42/teleprompter/commit/40e5365d760bd55b197324ee41b133f289116e62))
* **ci:** declare CFBundleVersion as $(CURRENT_PROJECT_VERSION) so TestFlight build-number override propagates ([#811](https://github.com/DaveDev42/teleprompter/issues/811)) ([bbad084](https://github.com/DaveDev42/teleprompter/commit/bbad084395dfb12609471c7ff481a2d4320033a7))
* **ci:** inject installerSigningCertificate for macOS .pkg export ([#809](https://github.com/DaveDev42/teleprompter/issues/809)) ([415f346](https://github.com/DaveDev42/teleprompter/commit/415f34619e89dfc14f99b5f0d19aaf49f5918668))
* **ci:** inject provisioningProfiles + teamID into ExportOptions at export time ([4b0c575](https://github.com/DaveDev42/teleprompter/commit/4b0c575646483c858436b283e629e0b56792f819))
* **ci:** keep archive stdout clean so $GITHUB_OUTPUT capture survives ([#806](https://github.com/DaveDev42/teleprompter/issues/806)) ([20c1cc5](https://github.com/DaveDev42/teleprompter/commit/20c1cc514342497e6892d19a31bbf8f5e7a33e03))
* **ci:** macOS App Sandbox + LSApplicationCategoryType, visionOS icon back-layer [@2x](https://github.com/2x) for ASC ([#810](https://github.com/DaveDev42/teleprompter/issues/810)) ([f0f94dd](https://github.com/DaveDev42/teleprompter/commit/f0f94dde68cc05a3f44e0be8902054b63fcca0ff))
* **ci:** manual code-signing per target/SDK for TestFlight archive ([#803](https://github.com/DaveDev42/teleprompter/issues/803)) ([b27e592](https://github.com/DaveDev42/teleprompter/commit/b27e5925f4152ed67b89fa6de4f1b732b29b023a))
* **ci:** rebuild xcframework when cache restores it without Info.plist ([#739](https://github.com/DaveDev42/teleprompter/issues/739)) ([43718a3](https://github.com/DaveDev42/teleprompter/commit/43718a33deb2ae43027d0caa8c4757759536e56b))
* **ci:** repair set-e and json_get bugs in setup-testflight-secrets.sh ([b6e7aa8](https://github.com/DaveDev42/teleprompter/commit/b6e7aa841d62e9cc55210a47447f7006dcd450d0))
* **ci:** select exact bundle id in setup-testflight-secrets.sh (prefix-match bug) ([#804](https://github.com/DaveDev42/teleprompter/issues/804)) ([2edd429](https://github.com/DaveDev42/teleprompter/commit/2edd429b2f21c1d82093555fc35e11fbb9ef51d5))
* **ci:** set TP_SKIP_ARM64_32 on macOS+visionOS TestFlight archive jobs ([#802](https://github.com/DaveDev42/teleprompter/issues/802)) ([23e5ea9](https://github.com/DaveDev42/teleprompter/commit/23e5ea94cccf7f3237e711f2479fcf7a91fe142c))
* **ci:** TestFlight preflight — rust-cache poisoning, watch compliance, trigger dedup ([#800](https://github.com/DaveDev42/teleprompter/issues/800)) ([3551fba](https://github.com/DaveDev42/teleprompter/commit/3551fbaac6378108cc818f212e41f6e485f5e53c))
* **ci:** testflight workflow parse error from arithmetic in GitHub Actions expression ([#777](https://github.com/DaveDev42/teleprompter/issues/777)) ([18b05f6](https://github.com/DaveDev42/teleprompter/commit/18b05f6def1ca4efe6acccaa3be23076aff0c791))
* **cli:** emit \r\n in session-cleanup raw-mode TUI to stop cursor staircase ([#816](https://github.com/DaveDev42/teleprompter/issues/816)) ([dd081e4](https://github.com/DaveDev42/teleprompter/commit/dd081e4d35637f9d24dd55085b8b712fa9d26be7))
* **cli:** harden tp-cli — daemon-stop race, upgrade rollback double-fault, IPC EOF classification, +7 audit findings ([#758](https://github.com/DaveDev42/teleprompter/issues/758)) ([6522523](https://github.com/DaveDev42/teleprompter/commit/6522523bcad2cb4b6f23f80a49315e9add0a5259))
* **cli:** make 'c' copy the pairing URL without needing Enter ([#813](https://github.com/DaveDev42/teleprompter/issues/813)) ([3ba7bdc](https://github.com/DaveDev42/teleprompter/commit/3ba7bdc8f6a44d3b72c5748b76c19f47e0f02abb))
* **cli:** tp upgrade replaces the full tarball bundle (bin/tp + tpd), not just the single binary ([#756](https://github.com/DaveDev42/teleprompter/issues/756)) ([c91a92a](https://github.com/DaveDev42/teleprompter/commit/c91a92a5a4bcdd17114d3eac53e98ed016c902c1))
* **daemon:** chat input submits to interactive claude via carriage return (\r), not newline ([#738](https://github.com/DaveDev42/teleprompter/issues/738)) ([90b027a](https://github.com/DaveDev42/teleprompter/commit/90b027ae8acd82a79e0e5293694fcb537a8924c3))
* **daemon:** generation-guard handleBye so a restarted session's old runner bye cannot corrupt it ([#786](https://github.com/DaveDev42/teleprompter/issues/786)) ([6384b79](https://github.com/DaveDev42/teleprompter/commit/6384b795962f4bae0cda44c758477e030188751b))
* **daemon:** guard worktree.remove against live sessions (refuse-non-force, kill-on-force) ([#790](https://github.com/DaveDev42/teleprompter/issues/790)) ([e0a5c96](https://github.com/DaveDev42/teleprompter/commit/e0a5c96bf51af096f59f81fb8cf5704824a1052b))
* **daemon:** harden trust-boundary surface (16 audit findings) ([#763](https://github.com/DaveDev42/teleprompter/issues/763)) ([d331e26](https://github.com/DaveDev42/teleprompter/commit/d331e26c306f8425c81294e94f2215a351f8d491))
* **daemon:** make relay broadcasts best-effort and delivery counts honest ([#773](https://github.com/DaveDev42/teleprompter/issues/773)) ([f66e973](https://github.com/DaveDev42/teleprompter/commit/f66e9732bec4857dffcf0323b90b4b78c1f9abd4))
* **daemon:** purge corrupt push_token rows on load instead of re-warning forever ([#779](https://github.com/DaveDev42/teleprompter/issues/779)) ([19f2054](https://github.com/DaveDev42/teleprompter/commit/19f2054ba01bfd605e460ae1583de9f4796ce93f))
* **daemon:** real-claude E2E harness + kx re-broadcast, app subscribe-on-broadcast, relay attached-count idempotency ([#736](https://github.com/DaveDev42/teleprompter/issues/736)) ([69f5e54](https://github.com/DaveDev42/teleprompter/commit/69f5e5466e0bfaa35c3dd9821caa7773b8b0d1ea))
* **daemon:** robustness guards for pairing/IPC/sid/export/lock (daemon-audit ranks 1-4,6) ([#776](https://github.com/DaveDev42/teleprompter/issues/776)) ([d4b55fd](https://github.com/DaveDev42/teleprompter/commit/d4b55fd7dad40180ade8d1d2f478d020701dd02a))
* **daemon:** roll back the worktree when createSession fails in worktree.create so a transient store error no longer orphans it ([#789](https://github.com/DaveDev42/teleprompter/issues/789)) ([f972e91](https://github.com/DaveDev42/teleprompter/commit/f972e91012f3d4a14cc3e6768a18e4c596c51b2c))
* **daemon:** sanitize worktree branch into an allowlist-safe sid so a legal '.'-branch no longer orphans the worktree ([#788](https://github.com/DaveDev42/teleprompter/issues/788)) ([b77db63](https://github.com/DaveDev42/teleprompter/commit/b77db6364a097a42d707519d15fcadd32096ef27))
* **daemon:** self-heal the IPC socket when its dirent is unlinked under a live daemon ([#778](https://github.com/DaveDev42/teleprompter/issues/778)) ([1ba45ff](https://github.com/DaveDev42/teleprompter/commit/1ba45ff8b66ab4d52782540771a21a8ccae02bbd))
* **daemon:** session.create subscribes relay + acks synchronously, raw entrypoint reconnects saved relays ([#734](https://github.com/DaveDev42/teleprompter/issues/734)) ([259974e](https://github.com/DaveDev42/teleprompter/commit/259974e53e3e154917eb6f173aa88c502c035c50))
* **daemon:** timer/socket-leak guards, worktree path hardening, pairing-resurrection + relay-subscription fixes (11 audit findings) ([#766](https://github.com/DaveDev42/teleprompter/issues/766)) ([9243144](https://github.com/DaveDev42/teleprompter/commit/92431445d223f82bbb2ced61b4fffe3131d4b5c1))
* **daemon:** unlink WAL/SHM sidecars on session delete + sweep orphans on startup ([#782](https://github.com/DaveDev42/teleprompter/issues/782)) ([7ef2cd3](https://github.com/DaveDev42/teleprompter/commit/7ef2cd3ee06b59a8a9d7af56e470271328afd470))
* **ios:** declare UISupportedInterfaceOrientations for App Store upload ([#807](https://github.com/DaveDev42/teleprompter/issues/807)) ([8f9100a](https://github.com/DaveDev42/teleprompter/commit/8f9100a3784dc08f733bf978a449cc148a1c4292))
* **ios:** inset QR scanner overlay to safe area so controls clear the notch ([#817](https://github.com/DaveDev42/teleprompter/issues/817)) ([3c844dc](https://github.com/DaveDev42/teleprompter/commit/3c844dc51a2260125c125e5c951c0735bc0f0413))
* **ios:** native macOS pairing buttons + toast safe-area inset ([#812](https://github.com/DaveDev42/teleprompter/issues/812)) ([9398fa2](https://github.com/DaveDev42/teleprompter/commit/9398fa238e34b7c24810c3befe3ac105ff023007))
* **ios:** opaque app icons + watch & visionOS app icons for App Store ([#808](https://github.com/DaveDev42/teleprompter/issues/808)) ([c05822f](https://github.com/DaveDev42/teleprompter/commit/c05822f64edb7fc422cb8398e85129192325ebab))
* **ios:** use explicit buttonStyle in Settings + add visionOS/watchOS platformString ([#818](https://github.com/DaveDev42/teleprompter/issues/818)) ([c68b40a](https://github.com/DaveDev42/teleprompter/commit/c68b40a3dc7836c0c9ae497da14925eea4e32046))
* **proto:** cap push-token length and resize dims in the tp-proto wire decoder ([#771](https://github.com/DaveDev42/teleprompter/issues/771)) ([397d667](https://github.com/DaveDev42/teleprompter/commit/397d66790cb58d233a982b224ec150375b4982e3))
* **protocol:** bound terminal dimensions, export limit, and push token at wire guards ([#769](https://github.com/DaveDev42/teleprompter/issues/769)) ([a428409](https://github.com/DaveDev42/teleprompter/commit/a42840975dc357f30b2c00b7ac1f95349227517a))
* **protocol:** harden the pairing deep-link decoder to match the native decoder ([#772](https://github.com/DaveDev42/teleprompter/issues/772)) ([6c65a67](https://github.com/DaveDev42/teleprompter/commit/6c65a67817ca552850c9145bbe143ec3d9b81c33))
* **relay:** add per-request deadline to APNs sends so a partition can't leak detached tasks ([#784](https://github.com/DaveDev42/teleprompter/issues/784)) ([b714209](https://github.com/DaveDev42/teleprompter/commit/b714209413d147418e733bdaa55487e0e31614bd))
* **relay:** bound per-daemon-group limiter lifecycle — no leak on clean close, no budget-doubling on re-register ([#787](https://github.com/DaveDev42/teleprompter/issues/787)) ([a7ee06b](https://github.com/DaveDev42/teleprompter/commit/a7ee06bd469d68112827719b93ee0ac01835f40d))
* **relay:** cap unbounded register/recentFrames maps + throttle pre-auth sockets ([#768](https://github.com/DaveDev42/teleprompter/issues/768)) ([ff68921](https://github.com/DaveDev42/teleprompter/commit/ff6892196f696e2963e994fac669f13f27613f7f))
* **relay:** close the socket on frontendId-missing auth reject (Rust port parity) ([#783](https://github.com/DaveDev42/teleprompter/issues/783)) ([db3f14c](https://github.com/DaveDev42/teleprompter/commit/db3f14cb87a8753276e9c3284d1991ce0ba0a0d1))
* **relay:** gate relay.push through the 2-layer GCRA rate limit before spawn ([#785](https://github.com/DaveDev42/teleprompter/issues/785)) ([b938cf0](https://github.com/DaveDev42/teleprompter/commit/b938cf014547afe63d8fbcd5e24bc8a12ee0efb7))
* **relay:** harden tp-relay — constant-time MAC compare, attach refcount, push rate-limit TOCTOU, +15 audit findings ([#759](https://github.com/DaveDev42/teleprompter/issues/759)) ([c2a2ede](https://github.com/DaveDev42/teleprompter/commit/c2a2ede0a404896b3f0c9b7cd86a5fa551ac3a61))
* **relay:** harden TS relay push/APNs path — crypto RNG, /admin auth, token validation (+5 audit fixes) ([#762](https://github.com/DaveDev42/teleprompter/issues/762)) ([c3997aa](https://github.com/DaveDev42/teleprompter/commit/c3997aa0839c7d3619f43572d94dafad2efad9f1))
* **relay:** port push-identity-authority + DoS caps into the live Rust relay ([#770](https://github.com/DaveDev42/teleprompter/issues/770)) ([1fc5c6a](https://github.com/DaveDev42/teleprompter/commit/1fc5c6a95fdf9f7319a0a46c7d18966467531ea5))
* **relay:** push-token identity authority + 3 leak/race hardening fixes (relay audit, 4 autonomous-safe findings) ([#767](https://github.com/DaveDev42/teleprompter/issues/767)) ([61cceed](https://github.com/DaveDev42/teleprompter/commit/61cceed61e6fcdb5f8b1d5bcd26822124a48f4ba))
* **release:** flatten bundle tarball so release publishes tarball assets ([#733](https://github.com/DaveDev42/teleprompter/issues/733)) ([3535745](https://github.com/DaveDev42/teleprompter/commit/353574549fff9fb25eb34337d3a73969e7c5284e))
* **runner:** IPC decode-throw teardown, hook sid traversal guard, byte-accurate buffer cap, bye-flush on shutdown ([#764](https://github.com/DaveDev42/teleprompter/issues/764)) ([fede7ad](https://github.com/DaveDev42/teleprompter/commit/fede7ad6fa8ca71d89fe069e4e735892db3c5ba8))
* **runner:** kill the PTY child in stop() so claude is not orphaned on teardown ([#781](https://github.com/DaveDev42/teleprompter/issues/781)) ([121e5f3](https://github.com/DaveDev42/teleprompter/commit/121e5f3768fa908bbf140f43c8638681d271a510))
* **rust:** tp-core/tp-proto secret-material memory hygiene + AEAD length guard ([#760](https://github.com/DaveDev42/teleprompter/issues/760)) ([a74eccb](https://github.com/DaveDev42/teleprompter/commit/a74eccb930fe8534c2289c64859d357c5d21891e))
