...
**현재 브랜치**: 없음 — #5 캐스케이드 종료 (main = PR8 #936 squash `a331eae6`). #4 flip 머지 완료(#922) — dogfood daemon 은 Rust `tp-daemon` 으로 구동, dogfood tp 는 캐스케이드 종료 시점 main 에서 재빌드 완료(v0.1.53, Rust-only 번들).
