...
- [ ] **External TestFlight (Beta App Review)** — internal은 리뷰 없이 완료됐으나 external 테스터로 확장하려면 첫 빌드 Beta App Review 제출 필요(`externalBuildState=READY_FOR_BETA_SUBMISSION`). 현재 미제출 — 필요 시 진행.
