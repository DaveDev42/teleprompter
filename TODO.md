...
- [ ] **Phase B: Apple 멀티플랫폼 확장 (ADR-0002)** — visionOS 완전 경험(B2: destination + spatial UX + 하니스) + watchOS 제한 경험(B3: 별도 타깃). B0 toolchain 게이트 PASS, B1 xcframework visionOS 슬라이스 완료.
