    ...
    <View className="flex-1 bg-tp-bg pt-20 items-center">
      <View className="w-full max-w-2xl px-6">
        ...
        <TextInput
          ...
          // Wire the input to the alert region above when an error is showing.
          // RN Web emits aria-invalid only from a direct prop, and
          // aria-describedby has no RN equivalent, so spread on web only.
