...
- tranche 3+ 는 잔여 A2.4 결정(#1 PTY spike, #3 locate, #4 relay trampoline, #5 cutover) 통과 후. tranche 3=interactive write(pair new QR/session cleanup TUI), 4=lifecycle thin, 5=run/passthrough(PTY spike).
